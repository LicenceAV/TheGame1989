...
terriblechose = [" le communisme", "les résultats de fin de projet python", "la guerre", """la montée en puissance des gens qui disent 'comme même'""""", "l'élection de Jean Lasalle", "la dernière mutation du Covid-19", "la pénurie de papier toilette", "la cérémonie des oscars présentée par Weinstein", "que l'homme qui dit dans la pub 'je mange mon chapeau' à mangé son chapeau", "le clash booba-kaaris", "la fin des choux", "le ramadan", "la fête du jambon à Alger", "la canicule en déembre"]
personnageP = ["Zindim Zibdane", "le Pape", "Jésus Cri", "Bill Portail", "Elonne Musque", "Jeffrey Baisos", "François Groland", "Bertrand Leheureux", "Pierre Olive", "Nicolat Hublot", "Emmanuel Macaron", "Philippe Edouard", "Jean-Luc Jesuisronchon", "Louis deFitness", "Quad Merad", "Narine Morano", "Baraque Obamot", "Michael Baie", "Vladimir Tabernac Poutine", "John lanone", "Nelson Mandala", "Tom Croisière", "Angelina Moche", "Donny Jepp", "Vin Sansplomb95"]
...
appar = ["femme","la chankla", "virginité", "maison", "arbre généalogique", "semestre", "chaise ogaming magnififque", "maman", "père", "agenda de la redoute", "calendrier avec des châtons des pompiers", "carte graphique RTX dernière génération 11go en GDDR6 cadencée à 1635 Mhz 2080ti", "comptable", "prépuce" ]
